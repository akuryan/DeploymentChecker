...
namespace RobotsTxt
{
    ...
    public class Robots : IRobotsParser
    {
        ...
        /// <summary>
        /// Checks if robots.txt file does not have any allow rule
        /// </summary>
        public bool HaveNoAllowRules { get; private set; }
        ...
        public bool IsPathAllowed(string userAgent, string path)
        {
            ...
            var ruleToUse = 
                this.AllowRuleImplementation == AllowRuleImplementation.MoreSpecific 
                ? 
